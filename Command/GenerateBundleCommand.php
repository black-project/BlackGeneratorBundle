...
use Black\Bundle\GeneratorBundle\Manipulator\RoutingManipulator;
...
<info>php app/console black:generate:bundle --namespace=Acme/BlogBundle</info>
...
<info>php app/console black:generate:bundle --namespace=Acme/BlogBundle --dir=src [--bundle-name=...] --no-interaction</info>

Note that the bundle namespace must end with "Bundle".
EOT
            )
            ->setName('black:generate:bundle')
        ;
    }
