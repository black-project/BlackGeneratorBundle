...
abstract class GeneratorCommand extends ContainerAwareCommand
{
    ...
    protected function getSkeletonDirs(BundleInterface $bundle = null)
    {
        ...
        if (isset($bundle) && is_dir($dir = $bundle->getPath().'/Resources/BlackGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }

        if (is_dir($dir = $this->getContainer()->get('kernel')->getRootdir().'/Resources/BlackGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }
